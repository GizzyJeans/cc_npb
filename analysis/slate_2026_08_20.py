...
DATE = "2026-08-20"
DATA_AS_OF = "2026-08-20 14:45 JST (UTC 05:45)"
...
GAMES = [
    BoardGame(
        ...
        away_starter="馬塔 (右)", home_starter="藤浪晋太郎 (右)",
        venue="横浜スタジアム (露天)",
...
STARTERS = {
    "DeNA": ("藤浪晋太郎", 1.0042, 3.83, "2 場 7.2 局 防禦率 4.70（樣本僅 7.2 局、10 四球，收縮後幾乎回到聯盟平均）", False),
    "巨人": ("マタ", 0.9278, 4.83, "4 場 19.1 局 防禦率 2.79（樣本僅 19.1 局、13 四球）", False),
    "阪神": ("下村海翔", 1.0335, 5.40, "5 場 27 局 防禦率 2.33（失分率 3.33 高於防禦率）", False),
    "ヤクルト": ("高橋奎二", 1.1016, 5.48, "11 場 60.1 局 防禦率 4.92", False),
    "広島": ("栗林良吏", 0.8318, 6.33, "12 場 76 局 防禦率 2.13、每場 6.3 局（已轉先發，非後援）", False),
    "中日": ("金丸夢斗", 0.8915, 6.39, "19 場 121.1 局 防禦率 2.67、108 三振", False),
    # 杉山遙希: 支配下登錄 (背號 47、1/26 公示) 但本季一軍 0 場登板，
    # 個人成績頁查無此人。以聯盟平均 1.00 當先驗，starter_stats_known 記為 False。
    "西武": ("杉山遙希", 1.0000, 5.00, "本季一軍 0 場登板（推測首度先發），無任何成績可用", False),
    "オリックス": ("エスピノーザ", 0.8687, 6.41, "17 場 109 局 防禦率 2.56、每場 6.4 局", False),
    "楽天": ("前田健太", 0.8799, 5.33, "10 場 53.1 局 防禦率 2.87", False),
    "ロッテ": ("小島和哉", 1.0224, 5.71, "14 場 80 局 防禦率 3.38", False),
}

BULLPEN_NOTE = {
    "DeNA": "8/18 用 3 人、8/19 用 3 人（東 97 球）；レイノルズ連兩日登板",
    "巨人": "8/18 用 4 人、8/19 只用 2 人（井上 109 球）—— 牛棚最充足",
    "阪神": "8/18 用 4 人、8/19 用 **6 人**（伊藤将 92 球、岩崎 26 球）；及川連兩日登板",
    "ヤクルト": "8/18 用 3 人、8/19 用 3 人（山野 114 球）；星連兩日登板",
    "広島": "8/18 用 4 人、8/19 用 **6 人**（鈴木 76 球）；菊地連兩日登板",
    "中日": "8/18 用 **6 人**、8/19 用 4 人（櫻井 97 球）；藤嶋連兩日登板",
    "西武": "8/18 用 4 人、8/19 用 5 人（渡邉 69 球）；無連兩日登板",
    "オリックス": "8/18 用 **6 人**、8/19 用 3 人（ジェリー 92 球）；無連兩日登板",
    "楽天": "8/18 用 4 人、8/19 用 4 人（岸 98 球）；無連兩日登板",
    "ロッテ": "8/18 用 4 人、8/19 用 4 人（ロング 63 球、髙橋 33 球、八木 33 球）；小野連兩日登板",
}
...
def readiness_for(game: BoardGame) -> DataReadiness:
    return DataReadiness(
        ...
        # 西武先發杉山遙希本季 0 場登板，查無成績 —— 照實記為缺口。
        starter_stats_known=JP[game.home_team] != "西武",
