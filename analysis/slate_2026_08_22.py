...
DATE = "2026-08-22"
DATA_AS_OF = "2026-08-22 12:40 JST (UTC 03:40)"
...
GAMES = [
    BoardGame(
        ...
        away_starter="增居翔太 (左)", home_starter="穆勒 (左)",
        ...
        f5_handicap_raw="1+55", f5_total_raw="3-50",
        attested_fields=frozenset({"total"}),
    ),
    BoardGame(
        date=DATE, start_time="14:00 JST（看板 13:00 台北）",
        away_team="歐力士猛牛", home_team="福岡軟銀鷹",
        away_starter="髙島泰都 (右)", home_starter="大津亮介 (右)",
        venue="みずほPayPayドーム (巨蛋)",
        handicap_raw="1-95", handicap_side="home",
        handicap_home_hk=0.950, handicap_away_hk=0.950,
        total_raw="8+75", over_hk=0.930, under_hk=0.930,
        f5_handicap_raw="1+45", f5_total_raw="4-50",
    ),
    BoardGame(
        date=DATE, start_time="14:00 JST（看板 13:00 台北）",
        away_team="廣島鯉魚", home_team="讀賣巨人",
        away_starter="玉村昇悟 (左)", home_starter="代木大和 (左)",
        venue="東京ドーム (巨蛋)",
...
STARTERS = {
    "ヤクルト": ("増居翔太", 0.8146, 4.60, "5 場 23 局 防禦率 1.57（樣本僅 23 局，收縮後拉回甚多）", False),
    "中日": ("マラー", 0.8815, 6.38, "14 場 89.1 局 防禦率 2.52、每場 6.4 局", False),
    "オリックス": ("髙島泰都", 1.1518, 4.25, "17 場 72.1 局 防禦率 3.86、被打 91 支", False),
    "ソフトバンク": ("大津亮介", 0.8698, 6.61, "17 場 112.1 局 防禦率 2.72、每場 6.6 局", False),
    "広島": ("玉村昇悟", 0.9025, 5.41, "9 場 48.2 局 防禦率 2.40", False),
    # 開局投手: 5 場 13 局、每場僅 2.6 局。
    "巨人": ("代木大和", 1.0121, 2.60, "5 場 13 局 防禦率 4.15（每場僅 2.6 局，後援用法）", True),
}

BULLPEN_NOTE = {
    "ヤクルト": "8/20 用 4 人、8/21 用 3 人（奥川 103 球）；無連兩日登板",
    "中日": "8/20 用 3 人、8/21 用 3 人（髙橋宏 123 球）；吉田連兩日登板",
    "オリックス": "8/20 用 2 人、8/21 休兵 —— 牛棚全休",
    "ソフトバンク": "8/20 用 **8 人**、8/21 休兵；休一天後負荷已回復",
    "広島": "8/20 用 2 人、8/21 只用 **1 人**（森下 125 球完投）—— 牛棚極為充足",
    "巨人": "8/20 用 5 人、8/21 用 5 人，堀田、田中瑛、マルティネス 三人連兩日登板"
            " —— 負荷偏重，而今日又派每場僅 2.6 局的開局投手",
}
